      ...
      return {
        ...
        trucks: state.trucks.map(truck => {
          ...
          if(action.payload.truckId === truck.id) {
            ...
            temp.customerRatingsAvg = Math.round(AvgRating/temp.customerRatings.length)
          } 
          return temp
        })
      }
          ...
          if(action.payload.truckId === truck.id) {
            temp.menu = truck.menu.map(menu => {
              ...
              if(action.payload.menuItemId === menu.id) {
                ...
                tempMenu.customerRatingsAvg = Math.round(AvgRating/tempMenu.customerRatings.length)
              }
              return tempMenu
            })
          } 
